...
var INPUT_OPTION = exports.INPUT_OPTION = Symbol("input_options");
var options = exports.options = (_options = {
    _intro: "You can type "
}, _defineProperty(_options, INPUT_OPTION, ["left", "right", "up", "down", "poke", "help"]), _defineProperty(_options, "outputOptions", function outputOptions() {
    var _this = this;

    var x = "";
    this[INPUT_OPTION].forEach(function (element) {
        x += _this._intro + " " + element + "<br/>";
    });
    return x;
}), _options);
...
var Encounter = exports.Encounter = function () {
    function Encounter() {
        var intro = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Hurrah!! You encounter a unicorn! You can fly to your dream destination!!";
...
var Bear = exports.Bear = function (_Encounter) {
    ...
    function Bear() {
        ...
        return _possibleConstructorReturn(this, (Bear.__proto__ || Object.getPrototypeOf(Bear)).call(this, "grr grow, you encounter a bear!!"));
    }
            ...
            return regeneratorRuntime.wrap(function poke$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 4:
                            _context2.next = 6;
                            return "Bear is attacking you !! What out..";
...
var Angel = exports.Angel = function (_Encounter2) {
    ...
    function Angel() {
        ...
        return _possibleConstructorReturn(this, (Angel.__proto__ || Object.getPrototypeOf(Angel)).call(this, "Wow!! You encounter a Angel!! It will give you strength and healing power!!"));
    }
...
var Ghost = exports.Ghost = function (_Encounter3) {
    ...
    function Ghost() {
        ...
        return _possibleConstructorReturn(this, (Ghost.__proto__ || Object.getPrototypeOf(Ghost)).call(this, "Booh!!, You encounter a Ghost!!"));
    }
...
var onChange = exports.onChange = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(files, tresCords, treasures) {
        var results;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 7:
                        ...
                        console.log("File reading error : ", _context.t0);
...
},{"babel-core/register":6,"babel-polyfill":7}],5:[function(require,module,exports){
'use strict';

var _environment = require('./environment.js');

var _addtions = require('./addtions.js');

var _fileprosessing = require('./fileprosessing.js');

var defultline = "Start Your Journey now!!";
var BR = "<br/>";
var evListner;
var x = 0,
    y = 0;
...
var fileinput;
evListner = function evListner() {
    var a = document.querySelector("#massage");
    command(a.value);
    a.value = "";
};

var enviroment = new _environment.Environment("Forest - ");
...
function command(massage) {
    if (massage == "left") {
        ...
        addmassaage(_addtions.options.outputOptions());
...
function main() {
    ...
    fileinput.onchange = function () {
        (0, _fileprosessing.onChange)(fileinput.files, tresCords, treasures);
    };
}
...
function findtreasure() {
    var findCords;
    tresCords.forEach(function (cords) {
    ...
    if (findCords) {
        var _treasures$get = treasures.get(findCords),
...
function addmassaage() {
    var massage = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defultline;

    var answer = document.querySelector("#massage-box");
    answer.innerHTML = answer.innerHTML + BR + massage;
}

main();

},{"./addtions.js":1,"./environment.js":3,"./fileprosessing.js":4}],6:[function(require,module,exports){
/* eslint max-len: 0 */
